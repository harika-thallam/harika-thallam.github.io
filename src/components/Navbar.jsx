...
const Navbar = () => {
  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo to="/">
          <ColorText>&lt;</ColorText>Harika
          <div style={{ color: theme.primary }}>/</div>Thallam
          <ColorText>&gt;</ColorText>
        </NavLogo>
        ...
        <NavItems>
          <NavLink onClick={() => handleNavLinkClick('About')} to="#About">About</NavLink>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            <NavLink onClick={() => handleNavLinkClick('About')} to="#About">
              About
            </NavLink>
            <NavLink onClick={() => handleNavLinkClick('Skills')} to="#Skills">
              Skills
            </NavLink>
            <NavLink onClick={() => handleNavLinkClick('Experience')} to="#Experience">
              Experience
            </NavLink>
